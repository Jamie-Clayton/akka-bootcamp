...
namespace ChartApp.Actors
{
    public class ChartingActor : ReceiveActor, IWithUnboundedStash
    {
        ...
        private void SetChartBoundaries()
        {
            ...
            maxAxisY = yValues.Count > 0 ? System.Math.Ceiling(yValues.Max()) : 1.0d;
            minAxisY = yValues.Count > 0 ? System.Math.Floor(yValues.Min()) : 0.0d;
        ...
        private void HandleMetrics(Metric metric)
        {
                ...
                _seriesIndex.ContainsKey(metric.Series))
            {
                ...
                //  On shut down the series.Points become null and causes an null reference exception
